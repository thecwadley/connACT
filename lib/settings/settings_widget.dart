            ...
            children: [
              ...
              Padding(
                ...
                child: FlutterFlowDropDown<String>(
                  ...
                  options: const [
                    'Yes (Please further describe your situation in the bio including what special Olympic sports are you interested in)',
                    'No'
                  ],
                  onChanged: (val) =>
                  ...
                  hintText: 'Are you a special Olympic athlete?',
                  icon: Icon(
                    Icons.keyboard_arrow_down_rounded,
                    color: FlutterFlowTheme.of(context).secondaryText,
                    size: 24.0,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.imagestring = await actions.uploadconvertimage();
                  ...
                  onPressed: !((_model.textController1.text != '') &&
                      ...
                      : () async {
                          await currentUserReference!
                            ...
                            photostring: _model.imagestring,
                            email: _model.textController2.text,
                            mySport: _model.dropDownValue1,
                            bio: _model.textController3.text,
                            specialOlympic: _model.dropDownValue2 != 'No',
                            myskilllevel: _model.dropDownValue3,
                          ));
                          context.safePop();
                        },
                  text: 'Save Changes',
