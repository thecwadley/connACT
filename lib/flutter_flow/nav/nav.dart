...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/joinGames',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'JoinGames')
              : const JoinGamesWidget(),
        ),
        FFRoute(
          name: 'confirmation',
          path: '/confirmation',
          asyncParams: {
            'selectedgame': getDoc(['Game'], GameRecord.fromSnapshot),
          },
          builder: (context, params) => ConfirmationWidget(
            selectedgame: params.getParam(
              'selectedgame',
              ParamType.Document,
            ),
          ),
